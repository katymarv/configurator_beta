...
import { G as GUI, T as TABS, d as MSP, e as MSPCodes, m as mspHelper } from '../TBFConfigurator/js/main.js';
    ...
    function update_ui() {
        ...
        */
        ...
        function process_servos(name, obj) {
            ...
            const subElement = `<input type="number" min="0" max="5000" value="`;
